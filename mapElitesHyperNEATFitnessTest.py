...
mapType = 1#int(sys.argv[1]) # Map type
mapNumber = 1 #int(sys.argv[2]) # Map Number
genomeNumber = 4#int(sys.argv[3]) # Genome number
try:
    failed1 = 0#int(sys.argv[4]) # Failed leg 1
except:
    failed_legs=[]
try:
