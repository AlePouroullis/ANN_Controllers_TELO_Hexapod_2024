...
CONFIG = neat.config.Config(neat.genome.DefaultGenome, neat.reproduction.DefaultReproduction,
                            ...
                            r'C:\Users\micha\PycharmProjects\HonoursProject\NEATHex\config-cppn')

config = neat.Config(neat.DefaultGenome, neat.DefaultReproduction,
                     neat.DefaultSpeciesSet, neat.DefaultStagnation,
                     r'C:\Users\micha\PycharmProjects\HonoursProject\NEATHex\config-feedforward')
...
def adaptive_performance_plots(mean_dataNEAT, mean_dataHyperNEAT):
    ...
    for scenario in range(5):
        data_NEAT20 = list(np.loadtxt(
            rf"C:\Users\micha\PycharmProjects\HonoursProject\mapElitesOutput\NEATSim\40000_niches\perfs_{scenario}.dat").flatten())
        data_NEAT40 = list(np.loadtxt(
            rf"C:\Users\micha\PycharmProjects\HonoursProject\mapElitesOutput\NEATSim\80000_niches\perfs_{scenario}.dat").flatten())
        sim_data_NEAT20.append(data_NEAT20)
        sim_data_NEAT40.append(data_NEAT40)
        data_HyperNEAT20 = list(np.loadtxt(
            rf"C:\Users\micha\PycharmProjects\HonoursProject\mapElitesOutput\HyperNEATSim\40000_niches\perfs_{scenario}.dat").flatten())
        data_HyperNEAT40 = list(np.loadtxt(
            rf"C:\Users\micha\PycharmProjects\HonoursProject\mapElitesOutput\HyperNEATSim\80000_niches\perfs_{scenario}.dat").flatten())
...
if __name__ == '__main__':
    ...
    filename = r'C:\Users\micha\PycharmProjects\HonoursProject\mapElitesOutput\NEAT\0_5000archive\archive_genome10002200.pkl'
    with open(filename, 'rb') as f:
        genomes = pickle.load(f)
    genome = genomes[225]

    # Load in HyperNEAT Reference Gait
    filename = r'C:\Users\micha\PycharmProjects\HonoursProject\mapElitesOutput\HyperNEAT\0_5000archive\archive_genome10002200.pkl'
    with open(filename, 'rb') as f:
        genomes = pickle.load(f)
    genome2 = genomes[16]
