...
if __name__ == '__main__':
    ...
    filename = 'mapElitesOutput/NEAT/'+ runNum+'_80000archive/archive_genome8012080.pkl'
    archive_load_file_name = 'mapElitesOutput/NEAT/'+runNum+'_80000archive/archive8012080.dat'
    ...
    archive = cvt_map_elites.compute(6, genomes, evaluate_gait, n_niches=mapSize, max_evals=10e6,
                                     log_file=open('mapElitesOutput/NEAT/' + runNum + "_" + str(mapSize) + '/log.dat', 'a'), archive_file='mapElitesOutput/NEAT/' + runNum + "_" + str(mapSize) + "archive" + '/archive',
                                     archive_load_file=archive_load_file_name, params=params, start_index=8012080,
                                     variation_operator=cm.neatMutation)